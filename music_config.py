...
MUSIC_PROMPTS: dict[str, str] = {
    "hook": (
        "Dark cinematic underscore in D minor, recognizable instruments: "
        "cello sustained drone, viola tremolo with quiet menace, spectral "
        "violin harmonics high in distance, sparse glockenspiel notes, "
        "deep double bass sub-bass impact on accents. Dark mystery "
        "atmosphere pulling the listener in. Designed for seamless "
        "background looping under documentary narration. 70 BPM, brooding "
        "and weighted, consistent dark intensity throughout."
    ),
    "setup": (
        "Slow cinematic underscore in D minor, recognizable instruments: "
        "low cello sustained drone, double bass pizzicato on downbeats, "
        "distant pipe organ chord swells, sparse low-register piano "
        "accents, single muted French horn note holding in distance. "
        "Dark mystery atmosphere with ominous tension. Designed for "
        "seamless background looping under documentary narration. 65 BPM, "
        "brooding and weighted, consistent dark depth throughout."
    ),
    "rising_tension": (
        "Building cinematic underscore in G sharp minor, recognizable "
        "instruments: cello sustained drone, viola tremolo with "
        "crescendoing intensity, ensemble strings building forward, low "
        "timpani rolls swelling, bass clarinet sustained low notes. Dark "
        "mystery atmosphere mounting forward unstoppable. Designed for "
        "seamless background looping under documentary narration. 75 BPM, "
        "mounting unease, dark intensity increasing gradually throughout."
    ),
    "shock": (
        "Dramatic cinematic underscore in F sharp minor, recognizable "
        "instruments: heavy cello drone, dissonant string clusters in "
        "violin and viola, low brass stab on impacts, deep double bass "
        "sub-bass with long reverb tails, percussive piano clusters in "
        "low register. Dark seductive intensity with ominous atmosphere. "
        "Designed for seamless background looping under documentary "
        "narration. 80 BPM, dark and consistent throughout."
    ),
    "consequences": (
        "Heavy cinematic underscore in D minor, recognizable instruments: "
        "solo cello sustained drone, double bass deep drone, pipe organ "
        "low chord swells, muted French horn sustained notes, distant "
        "timpani slow rolls. Dark mystery with crushing weighted gravity. "
        "Designed for seamless background looping under documentary "
        "narration. 60 BPM, brooding and ominous, consistent dark depth "
        "throughout."
    ),
    "resolution": (
        "Lingering cinematic underscore in D minor, recognizable "
        "instruments: solo cello sustained, viola sustained drone, pipe "
        "organ minor chord holding, sparse piano single notes in low "
        "register, bass clarinet sustained underneath. Dark mystery "
        "atmosphere with unresolved harmonic suspension that never fully "
        "releases. Designed for seamless background looping under "
        "documentary narration. 60 BPM, brooding and unresolved, "
        "consistent dark tension throughout."
    ),
    "outro": (
        "Fading cinematic underscore in D minor, recognizable instruments: "
        "cello fading into distance, distant pipe organ low chord, harp "
        "glissando descending slowly, double bass deep drone receding, "
        "spectral violin harmonics shimmering high. Dark mystery "
        "atmosphere with lingering unease that refuses to resolve. "
        "Designed for seamless background looping under documentary "
        "narration. 60 BPM, brooding and haunting, consistent dark "
        "throughout."
    ),
}
